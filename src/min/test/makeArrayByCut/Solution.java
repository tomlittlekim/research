package min.test.makeArrayByCut;
...
public class Solution {
    ...
    public String[] solution(String my_str, int n) {
        ...
        String[] answer = remain > 0 ? new String[quotient + 1] : new String[quotient];

        for (int i = 0; i < answer.length; i++) {
            if ((i + 1) * n > my_str.length()) answer[i] = my_str.substring(i * n);
    ...
    public String[] othersSolution(String my_str, int n) {
